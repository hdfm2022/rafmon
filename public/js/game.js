...
socket.on('youAreConnected', message => {
    ...
    $("#song").html("");
    $("#song").append("<audio id=\"myaudio\" controls autoplay loop> <source src=\"mp3/"+message.mapinfo.song+"\" type=\"audio/mpeg\">Your browser does not support the audio element.</audio>");
